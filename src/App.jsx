  ...
  return (
    <div className="wrapper">
      <div className="meadow-container">
        ...
        <Enemy currentImage={enemiesData[0].currentImage} position={enemiesData[0].position} orientation = {enemiesData[0].orientation}/>
        <Enemy currentImage={enemiesData[1].currentImage} position={enemiesData[1].position} orientation = {enemiesData[1].orientation}/>
        <Enemy currentImage={enemiesData[2].currentImage} position={enemiesData[2].position} orientation = {enemiesData[2].orientation}/>
